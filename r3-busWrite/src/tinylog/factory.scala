...
object factory {
  ...
  def buildBusWriteUnit4(r0: Bus, r1: Bus, r2: Bus, r3: Bus,
    ...
    var s0: Bus = (r0 && (!reset) && (!writeEnable)) | ((data && (!reset) && (writeEnable) && (!writeTo(1) && !writeTo(0)))) | (r0 && (!reset) && writeEnable && !(!writeTo(1) && !writeTo(0)))
    var s1: Bus = (r1 && (!reset) && (!writeEnable)) | ((data && (!reset) && (writeEnable) && (!writeTo(1) &&  writeTo(0)))) | (r1 && (!reset) && writeEnable && !(!writeTo(1) &&  writeTo(0)))
    var s2: Bus = (r2 && (!reset) && (!writeEnable)) | ((data && (!reset) && (writeEnable) && ( writeTo(1) && !writeTo(0)))) | (r2 && (!reset) && writeEnable && !( writeTo(1) && !writeTo(0)))
    var s3: Bus = (r3 && (!reset) && (!writeEnable)) | ((data && (!reset) && (writeEnable) && ( writeTo(1) &&  writeTo(0)))) | (r3 && (!reset) && writeEnable && !( writeTo(1) &&  writeTo(0)))
    (s0, s1, s2, s3)
  }
}
