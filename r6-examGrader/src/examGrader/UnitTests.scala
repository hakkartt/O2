...
"""
  ...
  @Test def testPointsToGraded() {
    assertEquals("grade for 9 points", 0, grader.pointsToGrade(9))
    assertEquals("grade for 10 points", 1, grader.pointsToGrade(10))
    assertEquals("grade for 16 points", 2, grader.pointsToGrade(16))
    assertEquals("grade for 25 points", 4, grader.pointsToGrade(25))
    assertEquals("grade for 26 points", 5, grader.pointsToGrade(26))
  }
  @Test def testPoints() {
  ...
  @Test def testGrading() {
    ...
    assertEquals("student 123456 grade", 4, grader.grades("123456"))
    assertEquals("student 783663 grade", 3, grader.grades("783663"))
  }
  @Test def testBestStudents() {
    assertEquals("best 1 students", List("123456"), grader.bestStudents(1))
    assertEquals("best 3 students", List("123456", "111111", "829399"), grader.bestStudents(3))
    assertEquals("best 4 students", List("123456", "111111", "829399", "783663"), grader.bestStudents(4))
  }
  @Test def testStudentsByGrade() {
    assertEquals("students with grade 3", Set("111111", "783663", "829399"), grader.studentsByGrade(3))
    assertEquals("students with grade 4", Set("123456"), grader.studentsByGrade(4))
    assertEquals("students with grade 5", Set(), grader.studentsByGrade(5))
  }
  @Test def testGradeByProgramme() {
    assertEquals("graded in Tik", Map("783663" -> 3, "123456" -> 4), grader.gradesByProgramme("Tik"))
    assertEquals("graded in Tfy", Map("111111" -> 3), grader.gradesByProgramme("Tfy"))
  }
}
